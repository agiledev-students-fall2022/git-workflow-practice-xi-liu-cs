...
3 variables is hard. trick is turn it into a parametric equation in just t, $V + t * W.\\$ 
taking something in 3d space, ignore everything in that 3d space except what matters to me right now marching along that ray is a 1d universe. it has a single variable t, a little ant walking along the ray, the ant lives its entire life along that ray.
...
bump into the sphere or not reduce complexity to 1d universe